      ...
      <table className="w-full text-sm text-left">
        ...
        <tbody>
          {[-50, -25, -10, 0, 10, 25, 50, 100].map(p => (
            <tr key={p} className={p === res ? 'bg-indigo-50 dark:bg-indigo-900/20 font-bold text-indigo-700 dark:text-indigo-300' : 'border-b border-slate-100 dark:border-slate-800'}>
