  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 mt-8">
      ...
      {customResult ? customResult : (
        <div className="p-6 bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-slate-200 dark:border-slate-700 flex flex-col items-center text-center">
          <h2 className="text-sm font-semibold text-slate-500 uppercase tracking-wider mb-4">Result</h2>
          <div className="text-4xl md:text-5xl font-bold text-indigo-600 dark:text-indigo-400 mb-4">{result}</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {table && (
          <div className="p-6 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 h-fit">
