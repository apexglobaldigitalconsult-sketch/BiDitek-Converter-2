...
export default function ResultDisplay({ solutionNum, triangle, derived, classification, isDeg, steps, diagram }: ResultDisplayProps) {
  ...
  return (
    <div className="space-y-6 bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 animate-in fade-in slide-in-from-bottom-4">
      {solutionNum && (
        <h2 className="text-2xl font-bold text-indigo-600 dark:text-indigo-400 border-b border-slate-200 dark:border-slate-700 pb-4">
