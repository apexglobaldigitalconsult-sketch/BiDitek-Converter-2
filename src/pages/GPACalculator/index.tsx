  ...
  const renderCourseTable = (courses: Course[], onUpdate: (id: string, field: keyof Course, val: any) => void, onRemove: (id: string) => void, canRemove: boolean) => (
    <div className="space-y-3">
      ...
      {courses.map((course, index) => (
        <div key={course.id} className="grid grid-cols-1 md:grid-cols-12 gap-3 p-4 md:p-0 bg-slate-50 md:bg-transparent dark:bg-slate-900/50 md:dark:bg-transparent rounded-xl border border-slate-200 md:border-none dark:border-slate-700 items-center">
            ...
            <div className="col-span-2 md:col-span-1 flex justify-end md:justify-center mt-2 md:mt-0">
              {canRemove && (
                <button 
                  ...
                  className="p-2 text-slate-400 hover:text-red-500 transition-colors bg-white md:bg-transparent dark:bg-slate-800 md:dark:bg-transparent rounded-lg border border-slate-200 md:border-none dark:border-slate-700"
                  title="Remove Course"
                >
                  <X className="w-5 h-5" />
                </button>
      ...
      <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-xl border border-slate-200 dark:border-slate-700 overflow-hidden">
        ...
        <div className="p-6 md:p-8 space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-wrap gap-3">
                <button 
                  ...
                  className="px-4 py-2 text-sm font-bold text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-900/20 hover:bg-indigo-100 dark:hover:bg-indigo-900/40 rounded-lg transition-colors flex items-center gap-2 disabled:opacity-50"
                >
          ...
          {mode === 'cumulative' && (
            <div className="space-y-6">
              {semesters.map((sem, i) => (
                <div key={sem.id} className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 overflow-hidden">
                  <div 
              ...
              <button 
                ...
                className="w-full py-4 border-2 border-dashed border-slate-300 dark:border-slate-700 rounded-2xl text-slate-500 hover:text-indigo-600 dark:hover:text-indigo-400 hover:border-indigo-300 dark:hover:border-indigo-700 hover:bg-indigo-50 dark:hover:bg-indigo-900/10 transition-all font-bold flex items-center justify-center gap-2 disabled:opacity-50 disabled:hover:bg-transparent disabled:hover:border-slate-300"
              >
